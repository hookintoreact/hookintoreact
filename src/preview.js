...
const RepoUrl =
  "https://github.com/hookintoreact/hookintoreact/tree/master/public/docs/";
...
export default function Preview(props) {
  ...
  return (
    <Container>
      <Helmet>
        <meta property="og:title" content={`Hook into React - ${name}`} />
        <meta
          property="og:url"
          content={`https://hookintoreact.github.io/${props.item.path}`}
        />
